...
leftShoulderJoint = gr.joint('shoulderJoint', {-90.0, 0.0, 90.0}, {-90.0, 0.0, 90.0})
...
leftArm:scale(4.0, 0.3, 0.3)
leftArm:translate(-0.08, -0.05, 0.0)
leftArm:rotate('z', 45);
leftShoulder:add_child(leftArm)
leftArm:set_material(red)

leftElbowJoint = gr.joint('leftElbowJoint', {0.0, 0.0, 90.0}, {0.0, 0.0, 0.0})
leftElbowJoint:scale(1.0, 1.0, 1.0)
leftElbowJoint:translate(-0.25, 0.0, 0.0)
leftArm:add_child(leftElbowJoint)

leftLowerArm = gr.mesh('cube', 'leftLowerArm')
leftLowerArm:scale(1.0, 1.0, 1.0)
leftLowerArm:translate(0.0, 0.0, 0.0)
